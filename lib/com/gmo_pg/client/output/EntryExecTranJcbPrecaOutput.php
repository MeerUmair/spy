...
/**
 * <b>JCBプリカ決済登録・決済一括実行  出力パラメータクラス</b>
 *
...
class EntryExecTranJcbPrecaOutput {
	...
	/**
	 * @var EntryTranJcbPrecaOutput JCBプリカ決済登録出力パラメータ
	 */
	var $entryTranJcbPrecaOutput;/*@var $entryTranJcbPrecaOutput EntryTranJcbPrecaOutput */

	/**
	 * @var ExecTranJcbPrecaOutput JCBプリカ決済実行出力パラメータ
	 */
	...
	/**
	 * JCBプリカ決済登録出力パラメータ取得
	 * @return EntryTranJcbPrecaOutput JCBプリカ決済登録出力パラメータ
	 */
	...
	/**
	 * JCBプリカ決済実行出力パラメータ取得
	 * @return ExecTranJcbPrecaOutput JCBプリカ決済実行出力パラメータ
	 */
	 ...
	 * JCBプリカ決済登録出力パラメータ設定
	 *
	 * @param EntryTranJcbPrecaOutput  $entryTranJcbPrecaOutput JCBプリカ決済登録出力パラメータ
	 */
	...
	/**
	 * JCBプリカ決済決済実行出力パラメータ設定
	 *
	 * @param ExecTranJcbPrecaOutput $execTranJcbPrecaOutput JCBプリカ決済実行出力パラメータ
	 */
	...
	function setAccessID($accessID) {
		...
		$this->execTranJcbPrecaOutput->setAccessID($accessID);
	}
