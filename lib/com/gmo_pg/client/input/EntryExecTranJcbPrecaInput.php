...
/**
 * <b>JCBプリカ決済登録・決済一括実行　入力パラメータクラス</b>
 *
...
class EntryExecTranJcbPrecaInput {
	...
	/**
	 * @var EntryTranJcbPrecaInput JCBプリカ決済登録入力パラメータ
	 */
	var $entryTranJcbPrecaInput;/* @var $entryTranInput EntryTranJcbPrecaInput */

	/**
	 * @var ExecTranJcbPrecaInput JCBプリカ決済実行入力パラメータ
	 */
