 ...
 */
class Mage_Catalog_Block_Product_Widget_Catchcopy extends Mage_Catalog_Block_Product_Catchcopy
    implements Mage_Widget_Block_Interface
{
    /**
     * Display products type
     */
    const DISPLAY_TYPE_NEW_PRODUCTS_CATCHCOPY = 'new_products_catchcopy';
    ...
    protected function _getProductCollection()
    {
        switch ($this->getDisplayType()) {
            case self::DISPLAY_TYPE_NEW_PRODUCTS_CATCHCOPY:
