 ...
 * @author     Verite Team <developers@innoexts.com>
 */
class Verite_Japanpost_Block_Adminhtml_Tablerate_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Website
     * 
     ...
     *
     * @return Verite_Japanpost_Block_Adminhtml_Tablerate_Grid
     */
    protected function _prepareCollection()
    {
        $websiteId = $this->getWebsiteId();
        $collection = Mage::getModel('japanpost/tablerate')->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('dest_region', array(
            ...
            'filter'	    => 'japanpost/adminhtml_tablerate_grid_column_filter_region', 
            'default'       => '*', 
        ));
        $this->addColumn('dest_zip', array(
            ...
            'align'         =>'left', 
            'index'         => 'dest_zip', 
            'filter'	    => 'japanpost/adminhtml_tablerate_grid_column_filter_zip', 
            'renderer'	    => 'japanpost/adminhtml_tablerate_grid_column_renderer_zip', 
            'default'       => '*', 
        ));
